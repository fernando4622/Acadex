...
import {
  ...
  FileText, Map, UserCog, Bell, AlertTriangle
} from 'lucide-react'
...
const NAV = {
  ADMIN: [
    { to: '/', label: 'Dashboard', icon: LayoutDashboard },
    {
      ...
      items: [
        ...
        { to: '/planes', label: 'Planes de Estudio', icon: FileText },
    ...
    },
    {
      section: 'Reportes',
      items: [
        { to: '/reportes', label: 'Centro de Reportes', icon: FileText },
        { to: '/mapa-riesgo', label: 'Mapa de Riesgo', icon: AlertTriangle },
      ]
    },
    {
      section: 'Sistema',
  ...
  DOCENTE: [
    ...
    { to: '/historial-docente', label: 'Mi Historial', icon: FileText },
    { to: '/periodos', label: 'Periodos', icon: CalendarDays },
  ...
  ALUMNO: [
    ...
    { to: '/historial', label: 'Kárdex', icon: FileText },
    { to: '/perfil', label: 'Perfil', icon: UserCog },
  ],
}
