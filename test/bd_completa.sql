...
BEGIN
    ...
    SELECT 
        ...
        COUNT(ra.calificacion) -- Cuenta cuántos tienen nota explícita (incluyendo 0)
    INTO v_base, v_count
    ...
    -- Si no hay ni una sola calificación registrada, el promedio base debe ser NULL para indicar "Pendiente"
    IF v_count = 0 THEN
        v_base := NULL;
    END IF;
...
BEGIN
    ...
    -- 2. Validar que el docente pertenezca al grupo
    IF v_docente_grupo <> p_docente_id THEN
